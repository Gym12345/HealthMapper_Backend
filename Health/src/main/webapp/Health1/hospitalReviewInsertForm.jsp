...
<head>
<meta charset="UTF-8">
<title><%=request.getParameter("hName")%>병원리뷰 화면</title>
</head>
<body>
...
<form action="HospitalReviewInsertController" method="post">
...
<input type="submit" value="리뷰등록"><br>
</form>
<a href="hospitalReviewList.jsp?hName=<%=request.getParameter("hName")%>">이전화면</a>
</body>
</html>