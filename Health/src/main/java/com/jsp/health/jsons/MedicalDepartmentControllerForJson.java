...
@WebServlet("/Health1/MedicalDepartmentControllerForJson")
public class MedicalDepartmentControllerForJson extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 ...
	 private DistanceDAO distanceDao;
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    ArrayList<HealthDTO> healthArr = dao.HDepartmentList(department);

		    request.setAttribute("healthArr", healthArr);
		    System.out.println(userLatitude + userLongitude + healthArr.toString());
